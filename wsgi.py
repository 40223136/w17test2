...
class Hello(object):
    ...
    齒數比:'''+str(N)+''':'''+str(N1)+''':'''+str(N2)+''':'''+str(N3)+'''<br />
    ...
    ctx.fillText("40223136黃金振繪製",x_g1-20, y_g1-10);
    ...
    ctx.font = "10px Verdana";
    ctx.fillText("40223136黃金振繪製:",x_g2-20, y_g2-10);
    ...
    ctx.font = "10px Verdana";
    ctx.fillText("40223119易柏翔繪製",x_g3-20, y_g3-10);
    ...
    ctx.fillText("40223119易柏翔繪製",x_g4-20, y_g4-10);
